		...
		function interpret_array($array){
			...
			foreach($array as $item){
				...
				switch($item_type){
					...
					break;					
					case 'subheader':
						$output .= '<div class="evoLANG_subheader">'.$item['label'].'</div><div class="evoLANG_subsec">';
					break;
			...
			$output =  array(
				...
				array('type'=>'togheader','name'=>__('General Calendar','eventon')),
					...
					array(
						...
						'label'=>'Event Tags','name'=>'evo_lang_eventtags',
					),
				array('type'=>'togend'),
			);
			...
			$output = array_merge($output, array(
				...
				array('type'=>'togheader','name'=>__('Event Card','eventon')),
					array(
						...
						'label'=>'Location','name'=>'evcal_lang_location',
					),array(
						'label'=>'Event Location','name'=>'evcal_lang_evloc',
					),array(
