...
class Tax_Meta_Class {
  ...
  public function __construct ( $meta_box ) {
    ...
    if (isset($meta_box['use_with_theme'])){
      if ($meta_box['use_with_theme'] === true){
        $this->SelfPath = dirname(__FILE__) . '/tax-meta-class';
  ...
  public function load_scripts_styles() {
    ...
    if (in_array($taxnow,$this->_meta_box['pages'])){
      ...
      wp_enqueue_style( 'tax-meta-clss', plugin_dir_url( __FILE__ ) . '/css/Tax-meta-class.css' );
      // Enqueue Meta Box Scripts
      wp_enqueue_script( 'tax-meta-clss', plugin_dir_url( __FILE__ ) . '/js/tax-meta-clss.js', array( 'jquery' ), null, true );
