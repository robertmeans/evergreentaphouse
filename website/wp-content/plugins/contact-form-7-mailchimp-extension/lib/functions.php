...
function wpcf7_mch_add_mailchimp($args) {
	...
	/*if ( ( ! isset( $cf7_mch['logfileEnabled'] ) ) or is_null( $cf7_mch['logfileEnabled'] ) ) {
		unset( $cf7_mch['logfileEnabled'] );
		$cf7_mch = $cf7_mch + array( 'logfileEnabled' => 1 ) ;
...
<div class="metabox-holder">
    ...
    <div>
        <p class="mail-field">
			<input type="checkbox" id="wpcf7-mailchimp-logfileEnabled" name="wpcf7-mailchimp[logfileEnabled]" value="1"<?php echo ( isset( $cf7_mch['logfileEnabled'] ) ) ? ' checked="checked"' : ''; ?> />
            <label for="wpcf7-mailchimp-cfactive"><b>Enable Debug Logger</b> to help you troubleshoot any issues with the extension.</label>
			<br />- View debug log file by clicking <a href="<?php echo esc_textarea( SPARTAN_MCE_PLUGIN_URL ). '/logs/log.txt'; ?>" target="_blank">here</a>.
			<br />- Reset debug log file by clicking <a href="<?php echo esc_textarea( $urlactual ). '&mce_reset_log=1'; ?>" target="_blank">here</a>.
        </p>
    </div>
